...
| `debugger` | Calls the Chrome DevTools Protocol method `Page.captureScreenshot` for full-page, element, and viewport frames. Scrollable captures keep one temporary connection while frames are stitched, then detach immediately. |
